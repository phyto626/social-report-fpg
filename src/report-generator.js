...
class ReportGenerator {
  constructor(analysisResult) {
    ...
    // Theme logic — brandKey 優先，其次 fallback 至品牌名稱
    const bk = (analysisResult.brandKey || '').toLowerCase();
    this.isEcoco = bk === 'ecoco' ||
      this.brandName.toLowerCase().includes('ecoco') ||
      this.brandName.toLowerCase().includes('eco');
    const isEcoco = this.isEcoco;
    this.c = {
